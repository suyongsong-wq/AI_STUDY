...
| Part 4 — 게시 | 인스타/단톡방 실제 게시 | ✅ 인스타 스토리 실제 업로드 → `스토리/게시_인스타스토리_스크린샷.jpeg` |
...
## 5. 비주얼 — 브랜드 맞춤 벡터 일러스트

히어로 원두 비주얼(원두백 + 바닥 원두 더미 + 앰버 스팟라이트)을 **브랜드 톤에 맞춰 직접 벡터(SVG)로 제작**했다
(`생성이미지/ember_히어로.svg`) — NEW DROP / ETHIOPIA GUJI · NATURAL / 컵노트 / ROASTED TO ORDER.
Ember의 웜블랙·앰버 톤에 정확히 맞고 **색·폰트가 브랜드와 일치하며 재현 가능**하다. (Q2와 동일 원칙)
