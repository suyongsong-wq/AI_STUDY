...
| `demo/타인인증_01-채팅방(123456).jpeg` | **본인 외 1명 실제 가입 & 채팅 인증** — 채팅방 양방향 대화 |
| `demo/타인인증_02-채팅목록.jpeg` | 판매자 계정의 채팅 목록 (상대 닉네임 노출) |
...
배포 URL을 공유해 **실제 다른 사람이 직접 가입하고 채팅**했습니다.

- 가입자: 닉네임 **123456** · 동네 서울 송파구 잠실동 (2026-07-19 18:28 가입)
- 대상 상품: 로직텍 모니터 받침대 + 무선키보드 (42,000원)
- 대화: 상대 "로지텍 모니터 다산다" → 판매자(수용) "넌 뭔데 반말이야" — **양방향 성립**

> 두 번째 계정을 만들어 자문자답하지 않고 실제 사용자로 채웠습니다.
