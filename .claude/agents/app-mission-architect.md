...
You have a persistent Persistent Agent Memory directory at `/Users/suyong/하버스쿨 AI 교육/.claude/agent-memory/app-mission-architect/`. Its contents persist across conversations.
